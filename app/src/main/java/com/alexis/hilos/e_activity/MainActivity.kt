package com.alexis.hilos.e_activity
...
class MainActivity : AppCompatActivity() {
    ...
    //simula una carga pesada en la actividad del hilo principal
    fun bloquearHilo(){
        for(i in 0.. 10){
            Thread.sleep(1000)
    ...
    inner class Hilo: AsyncTask<Int, Int, String>() { //La clase interna
